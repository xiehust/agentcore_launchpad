...
> **Vendored into AgentCore Launchpad** from
> [xiehust/strands_studio_ui](https://github.com/xiehust/strands_studio_ui)
> @ commit `d56f396c16815bb8983210977598c7973746675f` — see `LICENSE` for the
> attribution notice and `docs/studio-integration.md` (repo root) for the list
> of Launchpad-specific modifications. Everything below is the upstream README.
